...
#########################
# If necessary, create and then activate a conda environment with hmmer. I installed mine in "biopython"
...
cd /Users/jacquelinelemaire/Documents/phylo_class/phylo_class/analysis/hmmsearch/rp16
cat /Users/jacquelinelemaire/Documents/phylo_class/phylo_class/databases/rp16_list.txt | while read gene
do
