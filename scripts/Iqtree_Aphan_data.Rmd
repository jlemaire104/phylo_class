...
plot(iqtree.rooted, cex=.7, edge.color = "black", tip.color = species_colors_1, show.node.label=TRUE, main="A Maximum Likelihood IQTree of Aphanizomenon Muscle Alignment")
